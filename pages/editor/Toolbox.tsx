...
const Toolbox: FunctionComponent<ToolboxProps> = ({
  ...
  function addTweetElement(item: Element) {
    const pvid = clone(vid);
    const type = prompt("type 1 for TTSTweet or 2 for Just Tweet");
    ...
    if (type === "2") {
      pvid[selectedScene].timeline.push({
        ...
        element: {
          type: "Tweet",
          tlink:
            process.env.NEXT_PUBLIC_URL + "tweet/" + item.element.id + ".png",
          id: item.element.id,
        },
      });
      setVid(pvid);
              ...
              {vid.map((scene, index) => {
                return (
                  <div>
                    ...
                    <div className="my-2 grid grid-cols-2 gap-7">
                      <div>
                        <div className="text-xl font-bold opacity-60 mb-2">
                          Text
                        </div>
                        <div className="flex flex-nowrap overflow-auto gap-3 border h-full">
                      ...
                      <div className=" mb-10">
                        <div className="text-xl font-bold opacity-60 mt-4 mb-2  ">
                          Tweets
                        </div>
                        <div className="flex flex-nowrap overflow-auto gap-3 border ">
                          {scene.timeline.map((item) => {
                            if (
                              item.element.type === "TTSTweet" ||
                              item.element.type === "Tweet"
                            )
                              return (
                                <div
